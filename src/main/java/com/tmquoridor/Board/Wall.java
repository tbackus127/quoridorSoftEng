...
public class Wall {
   ...
   * @param ort the direction the wall is set at. Use Orientation.HORIZ or Orientation.VERT for distinguishing the
   *        directions.
   */
  ...
  /**
   * Gets the wall perpendicular to this wall (forms a + if both were to be placed). For example, (0,3):H would return
   * (1,2):V.
   * 
